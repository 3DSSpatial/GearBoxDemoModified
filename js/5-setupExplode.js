const { Color, Xfo, Vec3, KinematicGroup, NumberParameter, Material, TreeItem, Lines, GeomItem, Label, BillboardItem , BaseImage, FileImage} =
  window.zeaEngine;
...
const setupExplode = (asset) => {
  ...
  const addImage = (pos, basePose, name, imageFile) => {
    const image = new FileImage(name)
    image.load(imageFile)

    const billboard = new BillboardItem('billboard' + index, image);
    const xfo = new Xfo(pos);
    billboard.getParameter('LocalXfo').setValue(xfo);
    billboard.getParameter('PixelsPerMeter').setValue(1500);
    billboard.getParameter('AlignedToCamera').setValue(true);
  ...
  asset.once('loaded', () => {
    ...
    addImage(new Vec3(0.08, -1.6, 0.3), new Vec3(0.08, -1.6, 0.05), 'panel00', 'data/panel00.png');
    ...
    addImage(new Vec3(0.08, -0.4, 0.3), new Vec3(0.08, -0.4, 0.06), 'panel01', 'data/panel01.png');
    ...
    addImage(new Vec3(0.08, 0.16, 0.3), new Vec3(0.08, 0.16, 0.06), 'panel02', 'data/panel02.png');
